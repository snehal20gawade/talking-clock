...
public class HumanFriendlyClockServiceTest {
    ...
    public void currentTimeFourOClock(){
        ...
        assertThat(humanFriendlyClockService.humanFriendlyCurrentTime())
    ...
    void givenNumericTime_Four_O_Clock() {
        String humanFriendlyTime = humanFriendlyClockService.humanFriendlyTime(NUMERIC_TIME_FOUR_O_CLOCK);
        assertThat(HUMAN_FRIENDLY_FOUR_O_CLOCK).isEqualTo(humanFriendlyTime);
    }

    @Test
    void givenNumericTime_Half_Past_Four() {
        String humanFriendlyTime = humanFriendlyClockService.humanFriendlyTime(NUMERIC_TIME_HALF_PAST_FOUR);
    ...
    void givenInvalidNumericTime() {
        ...
        assertThrows(NumericTimeFormatException.class, () -> humanFriendlyClockService.humanFriendlyTime(INVALID_NUMERIC_TIME));
    }
}